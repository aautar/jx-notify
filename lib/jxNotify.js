var jxNotify = {
    ...
    styles: 
            (
                ...
                '.jxnotify p { margin:0; padding:0; color:#fff; font-weight:bold; text-align:center; line-height:24px; }' +
    ...
    _render: function(_notificationData) {
        ...
        var markup = '<div class="jxnotify ' + bgColorClass + '">' +
                        '<p>' + iconMarkup + ' ' + _notificationData.message + '</p>' +
                     '</div>';
